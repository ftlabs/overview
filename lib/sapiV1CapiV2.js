...
function correlateGroupInArticles( fnGetGroupFromArticle, articles ){
	...
	names.forEach( name1 => {
		...
		names.forEach( name2 => {
			...
			const name1Correlations = Object.keys( corrs[name1] );
			const name2Correlations = Object.keys( corrs[name2] );
	...
	// calc correlations of correlations of each names, i.e. the indirect correlations
