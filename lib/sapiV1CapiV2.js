...
function correlateMergedAnnotations( params = {}, articles=[] ){
	...
	const correlations = {
		...
		primaryThemes     : correlateGroupInArticles( a=>{ return [a.mergedAnnotations.primaryTheme]}, articlesInGenres),
		abouts            : correlateGroupInArticles( a=>{ return a.mergedAnnotations.abouts}, articlesInGenres),
		mentions          : correlateGroupInArticles( a=>{ return a.mergedAnnotations.mentions}, articlesInGenres),
		aboutsAndMentions : correlateGroupInArticles( a=>{ return a.mergedAnnotations.abouts.concat(a.mergedAnnotations.mentions) }, articlesInGenres),
	}
