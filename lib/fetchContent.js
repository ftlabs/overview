		...
		if(!!topics){
			topics.forEach(topic => {
				...
				if(obj === undefined){
					...
					obj = topicsWithArticles.find(function (obj) {
						return obj.topicName === topic.term.name;
					});
				}
				...
				obj.relatedTopics = topicHolder.concat(obj.relatedTopics);
				obj.relatedTopicCount = array.uniqueCount(obj.relatedTopics);
			});
		}
	});
